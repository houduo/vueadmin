			...
			<div class="container">
				<dl class="componyinfo">
					...
					<dd>
						...
						<p>
							电话：{{detail.scVo.tel}} <br /> 传真：{{detail.scVo.fax}}
						</p>
					</dd>
				</dl>
				<div class="checkdata">
				...
				<table v-if="baseinfo" border="1" cellspacing="" cellpadding="" class="tablebase">
					...
					<tr>
						<td class="title">团号</td>
						<td>{{detail.teamno}}</td>
						<td class="title">组团社</td>
					...
					<tr>
						<td class="title" >团款</td>
						<td colspan="3"></td>
						<td class="title">送团标志</td>
						<td colspan="3"></td>
					</tr>
					<tr>
